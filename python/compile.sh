...
g++ -O3 -Wall -shared -std=c++14 $(python3 -m pybind11 --includes) test_add.o add.o bound_fsp_weak.o c_bound_simple.o instance_taillard.o c_taillard.o -o test_add$(python3-config --extension-suffix)
